...
const Saves = (props) => {
    const { charClass, con, dex, wis, level } = props;
    let hero = {
    ...
    return (
        <div className="row">
            <div className="col">
                <Label>Fort:</Label> {calculateSave(hero.fort, con, level)}
            </div>
            <div className="col">
                <Label>Reflex:</Label> {calculateSave(hero.ref, dex, level)}
            </div>
            <div className="col">
                <Label>Will:</Label> {calculateSave(hero.will, wis, level)}
            </div>
        </div>
    );
}
